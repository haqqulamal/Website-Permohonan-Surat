          ...
          <div class='col-md-12'>
            <div class='box box-info'>
              <div class='box-header with-border'>
                <h3 class='box-title'>Tambah Data Buat Surat Perizinan Usaha</h3>
              </div>
              <div class='box-body'>
                <form method='POST' class='form-horizontal' action='surat_usaha-aksi' enctype="multipart/form-data">
                  <div class='col-md-12'>
                    <table class='table table-condensed table-bordered'>
                      <tbody>
                        ...
                        <tr>
                          <th scope='row'>nomor_surat</th>
                          <td><input type='text' class='form-control' name='nomor_surat' required
                        ...
                        <tr>
                          <th scope='row'>tempat_tanggal_lahir</th>
                          <td><input type='text' class='form-control' name='tempat_tanggal_lahir' required
                              oninvalid="this.setCustomValidity('Data tidak boleh kosong')"
                              oninput="setCustomValidity('')"> </td>
                        </tr>

                        <tr>
                          <th scope='row'>alamat_tempat_tinggal</th>
                          <td><input type='text' class='form-control' name='alamat_tempat_tinggal' required
                              oninvalid="this.setCustomValidity('Data tidak boleh kosong')"
                              oninput="setCustomValidity('')"> </td>
                        </tr>

                        <tr>
                          <th scope='row'>jenis_usaha</th>
                          <td><input type='text' class='form-control' name='jenis_usaha' required
                              oninvalid="this.setCustomValidity('Data tidak boleh kosong')"
                              oninput="setCustomValidity('')"> </td>
                        </tr>
                  ...
                  <select class='form-control' name='status' required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')">
                    ...
                    <option value="Ditolak">Ditolak</option>
                        ...
                        <tr hidden>
                          ...
                          <td><input type='text' class='form-control' name='status' value="Diajukan"> </td>
                        </tr>
