    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Buat Surat Perizinan Usaha</h1>
                <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <!-- /.box-header -->
                            <div class="box-body">
                                <a href="surat_usaha-add"><button class="btn btn-success" type="button"><i
                                ...
                                <table id="data" class="table table-bordered table-striped table-scalable">
                                    ...
                                    <tbody>
                                        ...
                                        while ($matakuliah = mysqli_fetch_array($querymatakuliah)) {
                                            ...
                                            <tr>
                                                <td>$no</td>
                                                <td>{$matakuliah['id_surat_usaha']}</td>
                                                <td>{$matakuliah['nomor_surat']}</td>
                                                <td>{$matakuliah['nama_lengkap']}</td>
                                                <td>{$matakuliah['nik']}</td>
                                                <td>{$matakuliah['tempat_tanggal_lahir']}</td>
                                                <td>{$matakuliah['alamat_tempat_tinggal']}</td>
                                                <td>{$matakuliah['jenis_usaha']}</td>
                                            ...
                                            if ($role === 'pejabat') {
                                                echo "
                                                <td>
                                                    <a href='surat_usaha-edit.php?id_surat_usaha={$matakuliah['id_surat_usaha']}' id='{$matakuliah['id_surat_usaha']}'>Edit</a>  <br>
                                                    <a href='#' onClick='confirm_delete(\"surat_usaha-delete.php?id_surat_usaha={$matakuliah['id_surat_usaha']}\")'>Delete</a> <br>
                                                    <a href='cetak_surat_usaha.php?id_surat_usaha={$matakuliah['id_surat_usaha']}' target='_blank' id='{$matakuliah['id_surat_usaha']}'>Cetak</a>
