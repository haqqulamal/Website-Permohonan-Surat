...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Persetujuan Permohonan</h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Daftar Permohonan Menunggu</h3>
            </div>
            <div class="card-body">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        while ($p = mysqli_fetch_assoc($permohonan_list)): ?>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                        data-target="#modalReview<?= $p['id_surat'] ?>">
                            ...
                            <!-- Modal Review -->
                            <div class="modal fade" id="modalReview<?= $p['id_surat'] ?>">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="proses.php" method="POST">
                                            <input type="hidden" name="id_surat" value="<?= $p['id_surat'] ?>">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Review Permohonan</h4>
