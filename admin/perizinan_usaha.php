    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>Permohonan SK Perizinan Usaha</h1>
                        ...
                        <div class="box">
                            <div class="box-body">
                                <?php if ($role_name == 'penduduk'): ?>
                                    <a href="perizinan_usaha-add.php"><button class="btn btn-success" type="button"><i
                                ...
                                <table id="data" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $where = "WHERE jenis_permohonan='Perizinan Usaha'";
