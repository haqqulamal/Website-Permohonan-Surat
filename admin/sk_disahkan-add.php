          ...
          <div class="row">
              ...
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Tambah Data SK Di SAHKAN</h3>
                </div>
              <div class='box-body'>
              <form method="POST" class='form-horizontal' action='sk_disahkan-aksi' enctype="multipart/form-data">
                <div class='col-md-12'>
                ...
                <option hidden>Pilih ID Pengesahan</option>
                <?php
                include "../koneksi.php";
                ...
                ?>
                      ...
                      <tr><th scope='row'>upload_sk_disahkan</th> <td><input type='file' class='form-control' name="upload_sk_disahkan"  
                      required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')"> 
                      <i style="float: left;font-size: 12px;color: red">*Format yang diperbolehkan *.PDF, *.DOC/DOCX dan ukuran max file 5 MB!</i>  </td></tr>   
