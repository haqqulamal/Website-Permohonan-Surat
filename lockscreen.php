...
<html>
 <head>
    <meta charset="utf-8">
    <title>Kredit - PT. Adira Dinamika Multi Finance Banjarmasin</title>
  <!-- Icon -->
  <link rel="shortcut icon" type="image/icon" href="../adira.png">
  ...
  <body class="hold-transition lockscreen">
    <div class="lockscreen-wrapper">
      <div class="lockscreen-logo">
        <b>Kredit - PT. Adira Dinamika Multi Finance Banjarmasin</b>
      </div>
      <!-- User name -->
