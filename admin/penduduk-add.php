        ...
        <div class="row">
          ...
          <div class='col-md-12'>
            <div class='box box-info'>
              ...
              <div class='box-body'>
                <form method='POST' class='form-horizontal' action='penduduk-aksi' enctype="multipart/form-data">
                  <div class='col-md-12'>
                    <table class='table table-condensed table-bordered'>
                      <tbody>
                        ...
                        <tr>
                          <th scope='row'>nik</th>
                          <td><input type='text' class='form-control' name='nik' required
                        ...
                        <tr>
                          ...
                          <td><input type='text' class='form-control' name='nama_lengkap' required
                              oninvalid="this.setCustomValidity('Data tidak boleh kosong')"
                              oninput="setCustomValidity('')"> </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td><input type='text' class='form-control' name='no_telp' required
                              oninvalid="this.setCustomValidity('Data tidak boleh kosong')"
                              oninput="setCustomValidity('')"> </td>
                        </tr>
