          ...
          <div class='col-md-12'>
            <div class='box box-info'>
              <div class='box-header with-border'>
                <h3 class='box-title'>Tambah Data Kepemilikan Tanah</h3>
              </div>
              <div class='box-body'>
                <form method='POST' class='form-horizontal' action='kepemilikan_tanah-aksi'
                    ...
                    <table class='table table-condensed table-bordered'>
                      <tbody>
                        ...
                        <tr hidden>
                          ...
                          <td><input type='text' class='form-control' name='jenis_permohonan' value="Kepemilikan Tanah">
                          </td>
                        </tr>
